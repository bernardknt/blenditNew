...
class AppointmentOptionsDialog extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Column(
            children : [
              ...
              Text('Choose Time', style: TextStyle(fontWeight: FontWeight.bold,
                color: kBlueDarkColor, fontSize: 20, ),),
              SizedBox(height: 10,),

              Text(' What time would you like you like to do this?', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold,
                  ...
                  children: [
                      ...
                      if (after.hour >= 6 && after.hour < 20){
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              title: Text('Ooops! We cant serve at that Time',textAlign: TextAlign.center, style: kHeading2TextStyleBold,),
                              content: Text('Time must be between 6 am and 8 pm.',textAlign: TextAlign.center, style: kNormalTextStyle.copyWith(fontSize: 18)),
                              actions: [
                                TextButton(
                                  onPressed: () {
                                    Navigator.pop(context);
                    ...
                    TextButton.icon(
                      onPressed: () async {
                        ...
                        if (deliveryTime.hour >= 6 && deliveryTime.hour < 20) {

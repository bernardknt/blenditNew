...
class DetoxPlansPage extends StatefulWidget {
  static String id = 'detox_plans_page';

  @override
  _DetoxPlansPageState createState() => _DetoxPlansPageState();
}


class _DetoxPlansPageState extends State<DetoxPlansPage> {

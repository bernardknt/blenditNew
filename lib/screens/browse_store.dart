...
class BrowseStorePage extends StatefulWidget {
  static String id = 'browse_store';



  @override

  _BrowseStorePageState createState() => _BrowseStorePageState();
}

class _BrowseStorePageState extends State<BrowseStorePage> {
